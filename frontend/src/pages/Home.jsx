  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex flex-col text-white w-11/12 justify-between items-center max-w-maxContent">
        ...
        <div className="text-white text-center text-4xl font-semibold mt-7 sm:text-2xl">
          Empower Your Future with <HighLightText message={"Coding Skills"} />
        </div>

        <div className="w-[90%] text-center text-lg text-richblack-300 mt-4 font-bold sm:text-sm">
          With our online coding courses, you can learn at your own pace, from anywhere in the world, and get access to a wealth of resources, including hands-on projects, quizzes, and personalized feedback from instructors.
        </div>

        <div className="flex gap-7 mt-8 flex-wrap justify-center">
          <div>
        ...
        <div className="relative my-12 shadow-blue-200 shadow-[-5px_-10px_50px_-5px] w-fit mx-auto sm:w-full">
        ...
        <div className="w-full px-4">
          <CodeBlocks 
            ...
            heading={
              <span>
                Unlock Your <HighLightText message="coding potential " /> with our online courses
              </span>
            }
      ...
      <div className="bg-pure-greys-5 text-richblack-700 pb-[100px]">
        <div className="homepage_bg h-[333px] flex justify-center items-center">
          <div className="w-11/12 max-w-maxContent flex flex-col items-center gap-5 mx-auto justify-between">
            <div className="h-[150px]">
            </div>

            <div className="flex gap-7 text-white flex-wrap justify-center">
              <div>
        ...
        <div className="mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between mt-[100px] gap-10">
          <div className="flex flex-wrap gap-5 justify-between">
            <div className="text-4xl font-semibold w-full lg:w-[45%] text-center lg:text-left">
